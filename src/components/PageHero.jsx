...
export default function PageHero({
  ...
  return (
    <section
      className={`relative overflow-hidden border-b border-slate-200 ${fullHeight ? "min-h-[100vh]" : ""}`}
    >
      ...
      >
        <div>
          <h1 className="max-w-4xl text-4xl font-bold leading-tight sm:text-5xl text-white">
            {title}
          </h1>
